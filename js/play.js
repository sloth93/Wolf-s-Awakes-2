   ...
   //var y = game.world.randomY;
    ...
    enemigosVivos = 30;
        ...
        //enemies.push(this.enemies);
         this.coin = game.add.sprite(6100, 1400, 'coin');
...
//    }
   ...
   //Sistema per matar enemics disparant
	...
	powerUp: function() {
		...
		for (var i = 0; i < powerUp_pos.length; i++) {
			  if (powerUp_pos[i].x === this.coin.x) {
                 powerUp_pos.splice(i, 1);
                this.coin.reset(powerUp_pos[i]);
              }
